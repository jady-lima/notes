        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <div class="col card p-5 text-center">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('index') }}" class="btn btn-primary px-5 m-2"><i class="fa-solid fa-xmark me-2"></i>No</a>
                        <a href="{{ route('deleteNoteConfirm', Crypt::encrypt(['id' => $note->id])) }}" class="btn btn-danger px-5 m-2"><i class="fa-solid fa-trash me-2"></i>Yes</a>
                    </div>
                </div>
